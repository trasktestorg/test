...
retval = 0
retval += sanitycheck('.github/CODEOWNERS', allow_eol = (LF,), indent = 2)
retval += sanitycheck('**/*.json', allow_eol = (LF,), indent = 2)
retval += sanitycheck('**/*.json5', allow_eol = (LF,), indent = 2)
retval += sanitycheck('**/*.md', allow_eol = (LF,))
retval += sanitycheck('**/*.py', allow_eol = (LF,), indent = 2)
retval += sanitycheck('**/*.tf', allow_eol = (LF,), indent = 2)
