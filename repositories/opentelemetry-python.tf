module "opentelemetry-python-repo" {
...
module "opentelemetry-python-branch-protection-rule-0" {
  source = "../modules/branch-protection-long-term"
  repository_id = module.opentelemetry-python-repo.node_id
  pattern = "main"
...
module "opentelemetry-python-branch-protection-rule-1" {
  source = "../modules/branch-protection-long-term"
  repository_id = module.opentelemetry-python-repo.node_id
  pattern = "v[0-9]*.[0-9]*.x"
  require_code_owner_reviews = false
...
module "opentelemetry-python-branch-protection-rule-2" {
  source = "../modules/branch-protection-long-term"
  repository_id = module.opentelemetry-python-repo.node_id
  pattern = "release/*"
  require_code_owner_reviews = false
  ...
  depends_on = [module.opentelemetry-python-branch-protection-rule-1]
}

module "opentelemetry-python-branch-protection-rule-3" {
  source = "../modules/branch-protection-feature"
  repository_id = module.opentelemetry-python-repo.node_id
  pattern = "dependabot/**/**"
  depends_on = [module.opentelemetry-python-branch-protection-rule-2]
}

module "opentelemetry-python-branch-protection-rule-4" {
  source = "../modules/branch-protection-feature"
  repository_id = module.opentelemetry-python-repo.node_id
  pattern = "opentelemetrybot/**/**"
  required_status_checks_no_easy_cla = true
  depends_on = [module.opentelemetry-python-branch-protection-rule-3]
}
